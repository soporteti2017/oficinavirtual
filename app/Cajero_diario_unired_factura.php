...
class Cajero_diario_unired_factura extends Model
{
    protected $table = "cajero_diario_unired_factura";
    ...
    public static function getcajero_diario_unired_factura($fecha, $usuario_id){
        return Cajero_diario_unired_factura::where('fecha', '=', $fecha)->where('usuario_id', '=', $usuario_id)
