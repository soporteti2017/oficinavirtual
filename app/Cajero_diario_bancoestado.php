...
class Cajero_diario_bancoestado extends Model
{
    protected $table = "cajero_diario_bancoestado";
    ...
    public static function getcajero_diario_bancoestado($fecha, $usuario_id){
        return Cajero_diario_bancoestado::where('fecha', '=', $fecha)->where('usuario_id', '=', $usuario_id)
