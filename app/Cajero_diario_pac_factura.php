...
class Cajero_diario_pac_factura extends Model
{
    protected $table = "cajero_diario_pacs_facturas";
    ...
    public static function getcajero_diario_pacs_facturas($fecha, $usuario_id){
        return Cajero_diario_pac_factura::where('fecha', '=', $fecha)->where('usuario_id', '=', $usuario_id)
