...
class Cajero_diario_otros_bancos extends Model
{
    protected $table = "cajero_diario_otros_bancos";
    ...
    public static function getcajero_diario_otros_bancos($fecha, $usuario_id){
        return Cajero_diario_otros_bancos::where('fecha', '=', $fecha)->where('usuario_id', '=', $usuario_id)
