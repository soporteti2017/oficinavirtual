...
class Cajero_diario_pat extends Model
{
    protected $table = "cajero_diario_pats";
    ...
    public static function getcajero_diario_pats($fecha, $usuario_id){
        return Cajero_diario_pat::where('fecha', '=', $fecha)->where('usuario_id', '=', $usuario_id)
