...
class Cajero_diario_bancoestado_dia_factura extends Model
{
    protected $table = "cajero_diario_bancoestado_al_dia_factura";
    ...
    public static function getcajero_diario_bancoestado_al_dia_factura($fecha, $usuario_id){
        return Cajero_diario_bancoestado_dia_factura::where('fecha', '=', $fecha)->where('usuario_id', '=', $usuario_id)
