...
class Cajero_diario_serviestado_factura extends Model
{
    protected $table = "cajero_diario_serviestado_factura";
    ...
    public static function getcajero_diario_serviestado_factura($fecha, $usuario_id){
        return Cajero_diario_serviestado_factura::where('fecha', '=', $fecha)->where('usuario_id', '=', $usuario_id)
