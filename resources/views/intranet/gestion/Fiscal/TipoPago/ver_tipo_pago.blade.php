...
@section('titulo', 'Ver Tipo de Pago')
		 ...
		 <div class="col-md-10">	
		 	...
		 	<div class="panel panel-default">
                ...
                <div class="panel panel-primary">
				  <div class="panel-heading"><strong>Ver Tipo de Pago:</strong> </div>
				  <div class="panel-body">
				    
				  	{!! Form::open(['route' => 'gestion.Fiscal.TipoPago.solicita_tipo_pago', 'method' => 'POST'])  !!}
