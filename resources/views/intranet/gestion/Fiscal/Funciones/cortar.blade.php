...
@section('titulo', 'Cortar Impresora Fiscal')
		 ...
		 <div class="col-md-10">	
		 	...
		 	<div class="panel panel-default">
                ...
                <div class="panel panel-primary">
				  <div class="panel-heading"><strong>Cortar Papel Impresora Fiscal:</strong> </div>
				  <div class="panel-body">
				    
				  	{!! Form::open(['route' => 'gestion.Fiscal.Funciones.generacorte', 'method' => 'POST'])  !!}
						...
						<div class="form-group">
							{!! Form::submit('Cortar', ['class' => 'btn btn-primary large']); !!}
						</div>
					{!! Form::close() !!}	
