...
@section('titulo', 'Conf. Encabezado')
		 ...
		 <div class="col-md-10">	
		 	...
		 	<div class="panel panel-default">
                ...
                <div class="panel panel-primary">
				  <div class="panel-heading"><strong>Configurar Encabezado:</strong> </div>
				  <div class="panel-body">
				    
				  	{!! Form::open(['route' => 'gestion.Fiscal.Boleta.solicita_encabezado', 'method' => 'POST'])  !!}
                        <div class="row">
                                <div class="col-md-12">
