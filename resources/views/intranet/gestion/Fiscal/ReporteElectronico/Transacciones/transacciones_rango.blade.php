		 ...
		 <div class="col-md-10">	
		 	...
		 	<div class="panel panel-default">
                ...
                <div class="panel panel-primary">
				  <div class="panel-heading"><strong>Reportes transacciones por Rango:</strong> </div>
				  <div class="panel-body">
				    
				  	{!! Form::open(['route' => 'gestion.Fiscal.ReporteElectronico.Transacciones.solicita_transacciones_rango', 'method' => 'POST'])  !!}
					  	<div class="row">
						  	<div class="col-md-12">
