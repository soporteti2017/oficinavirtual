		 ...
		 <div class="col-md-10">	
		 	...
		 	<div class="panel panel-default">
                ...
                <div class="panel panel-primary">
				  <div class="panel-heading"><strong>Reportes Cierres Z por Fecha:</strong> </div>
				  <div class="panel-body">
				    
				  	{!! Form::open(['route' => 'gestion.Fiscal.ReporteElectronico.Cierrez.solicita_cierrez_fecha', 'method' => 'POST'])  !!}
					  	<div class="row">
						  	<div class="col-md-12">
