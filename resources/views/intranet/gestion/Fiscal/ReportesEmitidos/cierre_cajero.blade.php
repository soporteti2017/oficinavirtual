...
@section('titulo', 'Cierre de cajero')
		 ...
		 <div class="col-md-10">	
		 	...
		 	<div class="panel panel-default">
                ...
                <div class="panel panel-primary">
				  <div class="panel-heading"><strong>Cierre de cajero:</strong> </div>
				  <div class="panel-body">
				    
				  	{!! Form::open(['route' => 'gestion.Fiscal.ReportesEmitidos.solicita_cierre_cajero', 'method' => 'POST'])  !!}
						...
						<div class="form-group">
							{!! Form::submit('Realizar Cierre', ['class' => 'btn btn-primary large']); !!}
						</div>
					{!! Form::close() !!}	
