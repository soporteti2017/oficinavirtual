		 ...
		 <div class="col-md-10">	
		 	...
		 	<div class="panel panel-default">
                ...
                <div class="panel panel-primary">
				  <div class="panel-heading"><strong>Reporte Z:</strong> </div>
				  <div class="panel-body">
				    
				  	{!! Form::open(['route' => 'gestion.Fiscal.ReportesEmitidos.solicita_reporte_z', 'method' => 'POST'])  !!}
						...
						<div class="form-group">
							{!! Form::submit('Realizar reporte', ['class' => 'btn btn-primary large']); !!}
						</div>
					{!! Form::close() !!}	
