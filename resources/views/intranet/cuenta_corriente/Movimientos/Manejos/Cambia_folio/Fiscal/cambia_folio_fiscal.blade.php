		 ...
		 <div class="col-md-10">	
		 	...
		 	<div class="panel panel-default">
                ...
                <div class="panel panel-primary">
				  <div class="panel-heading"><strong>Cambio Folio Fiscal:</strong> </div>
				  <div class="panel-body">
				    
				  	{!! Form::open(['route' => ['cuenta_corriente.actualiza_folio', $usuario->id], 'method' => 'PUT'])  !!}
                        <div class="row">
                            
                                <div class="col-md-12">
                                        <div class="form-group" id="encabezado">
                                            {!! Form::label('folioactual', 'Folio Actual: ') !!}
                                            {!! Form::text('folioactual', $usuario->boleta4, ['class' => 'form-control', 'required', 
