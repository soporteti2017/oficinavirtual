		 ...
		 <div class="col-md-10">	
		 	<div class="panel panel-default">
		        ...
		        <div class="panel-body">
                    ...
                    <strong><h3>TRABAJO A REALIZAR</h3></strong>
                    <table width="100%" border="0">
                        <tr>
                            <td width="30%"><strong>DESCRIPCIÓN</strong></td>
                            <td width="25%" align="center"><strong>MAC</strong></td>
                            <td width="20%" align="center"><strong>PLAN</strong></td>
                            <td width="25%" align="center"><strong>CM</strong></td>
                        </tr>
                        @foreach($orden_trabajo->ordenes_trabajos_detalles as $orden_trabajo_detalle)
                            <tr>
                                <td width="30%">{{ $orden_trabajo_detalle->servicio->descripcion }}</td>
                                <td width="25%" align="center">{{ $cmmac->id }}</td>
                                <td width="20%" align="center">{{ $cmmac->servinet_id }}</td>
                                <td width="25%" align="center">{{ $cmmac->cm }}</td>
                            </tr>
                        @endforeach
                    </table>
