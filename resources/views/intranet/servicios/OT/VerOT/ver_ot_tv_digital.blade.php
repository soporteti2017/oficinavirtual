		        ...
		        <div class="panel-body">
                    ...
                    <table width="100%" border="0">
                        <tr>
                            ...
                            <td width="20%" align="center"><strong>BOCAS ADIC</strong></td>
                        ...
                        @foreach($orden_trabajo->ordenes_trabajos_detalles as $orden_trabajo_detalle)
                            <tr>
                                ...
                                <td width="20%" align="center">{{ $boc_adic }}</td>
                    ...
                    <strong><h4>Nota</h4></strong>

                    <table width="100%" border="0">
                        <tr>
                            <td width="100%">
                                <strong><p> El servicio funcionará correctamente en los televisores que cumplen la norma ISDBTb 
                                (Norma adpatada por chile según decreto N° 136/2009 Subtel). 
                                El listado de televisores que cumplen con dicha norma lo puede encontrar en web.cablecolor.cl/TVD2.php (Fuente Subtel)</p></strong>
                            </td>
                        </tr>
                    </table>
