		        ...
		        <div class="panel-body">
                    ...
                    <table width="100%" border="0">
                        <tr>
                            ...
                            <td width="30%" align="center"><strong>CM ANTIGUO</strong></td>
                            <td width="30%" align="center"><strong>CM NUEVO</strong></td>
                        </tr>
                        @foreach($orden_trabajo->ordenes_trabajos_detalles as $orden_trabajo_detalle)
                            <tr>
                                ...
                                <td width="30%" align="center">{{ $mac_cambios[0]->serieantigua }}</td>
                                <td width="30%" align="center">{{ $mac_cambios[0]->serienueva }}</td>
                            </tr>
                        @endforeach
                    </table>
