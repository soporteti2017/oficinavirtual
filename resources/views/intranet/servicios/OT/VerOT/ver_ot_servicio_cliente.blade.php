		 ...
		 <div class="col-md-10">	
		 	<div class="panel panel-default">
		        ...
		        <div class="panel-body">
                    ...
                    <table width="100%" border="0">
                        <tr>
                            <td width="20%"><strong>Reclamo Cliente:</strong></td>
                            <td width="50%">
                            {{ $orden_trabajo->reclamo }}
                            @if($inet == "SI")
                                {{ $cm_cliente[0]->cmmac->cm. " / " .$contrato_plan[0]->servinet_id }}
                            @endif
                            </td>
                            <td width="20%"><strong>Bocas adic. :</strong></td>
                            <td width="10%">{{ $boc_adic }}</td>
                        </tr>
                    </table>
