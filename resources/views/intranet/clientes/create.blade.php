...
<div class="form-group">
	...
	<div class="col-lg-3">
	{!! Form::text('paterno',null, ['class' => 'form-control', 'placeholder' => 'Apellido paterno','required' ]) !!}
	</div>

	{!! Form::label('materno','Apellido materno',['class' => 'col-lg-2 control-label']) !!}
	<div class="col-lg-3">
	{!! Form::text('materno',null, ['class' => 'form-control', 'placeholder' => 'Apellido materno','required' ]) !!}
	</div>
...
<div class="form-group">
	...
	<div class="col-lg-3">
	{!! Form::text('nacionalidad',null, ['class' => 'form-control', 'placeholder' => 'Chileno','required' ]) !!}
	</div>

	{!! Form::label('telefono1','Telefono 1',['class' => 'col-lg-2 control-label']) !!}
	<div class="col-lg-3">
	{!! Form::text('telefono1',null, ['class' => 'form-control', 'placeholder' => '9xxxxxxxx','required' ]) !!}
	</div>
...
<div class="form-group">
	...
	<div class="col-lg-3">
	{!! Form::text('telefono2',null, ['class' => 'form-control', 'placeholder' => '532xxxxxx']) !!}
	</div>
